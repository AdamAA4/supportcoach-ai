...
_Outgoing model: replace this with the completed work, changed behavior, and files changed._

## Checks run

_Outgoing model: replace this with exact commands and results. State when a check was not run._

## Remaining work or known issues

_Outgoing model: replace this with unfinished work, risks, and the next concrete step._

## Instructions for the next agent

_Outgoing model: replace this with the approved scope and any files or behavior that must be preserved._
