      ...
      <dl className="mt-3 text-[13.5px]">
        ...
        {canonicalLink && (
          <div className="border-b border-dashed border-tape-line py-2">
            ...
            <dd className="mt-1 break-all"><a className="font-semibold text-accent-strong underline underline-offset-2 transition-opacity duration-200 hover:opacity-75" href={canonicalLink} target="_blank" rel="noreferrer">{canonicalLink}</a></dd>
          </div>
        )}
      </dl>
      <section className="mt-5" aria-labelledby="facts-heading">
        <h3 id="facts-heading" className="text-[11px] font-bold uppercase tracking-[0.14em] text-tape-muted">FAQ and policy facts</h3>
